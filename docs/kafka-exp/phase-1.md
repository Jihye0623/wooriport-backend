...
> **재측정 (2026-06-09 · 데스크탑 · 18유저 · N=100k 전량 드레인)**: v0 **305.8** → v1 **253.8 msg/s** (**−17%**),
> persist p50 v0 2.49 → v1 3.15 ms — 2026-06-07 측정(−18%, 3.15 ms)과 일치. 같은 머신·같은 데이터셋이라
> Phase 2/3 와 직접 비교 가능한 기준선 (절대값이 아닌 같은-머신 상대 델타로 비교 — HANDOFF §4).
