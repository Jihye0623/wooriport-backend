...
> **재측정 (2026-06-09 · 데스크탑 · 18유저 · N=100k 전량 드레인)**: consumer 처리량 **305.8 msg/s**
> (= 100k ÷ E2E_max 327 s), tx.persist p50 **2.49 ms** / p95 2.88 ms — 2026-06-07 측정(~301 msg/s, 2.49 ms)과 일치.
> 데이터셋 3→18유저 변경이 baseline 처리량·persist 특성에 영향 없음 확인 = **Phase 3 비교의 동일-머신/동일-데이터 기준선**.
